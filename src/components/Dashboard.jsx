...
function Dashboard() {
  ...
  const handleConfirmLogout = () => {
    ...
    setShowPopup(false);
    navigate("/", { replace: true }); // remove dashboard from history
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-100 via-indigo-100 to-purple-200">
      ...
      <div className="flex flex-col items-center justify-center mt-24">
        <div className="bg-white/80 backdrop-blur-lg p-10 rounded-2xl shadow-2xl 
                        text-center border border-indigo-200">
